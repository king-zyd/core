...
public class ConvertTest {
    ...
    public void toDateShouldReturnDefaultValueWithInvalidFormat() {
        Date date = Convert.toDate("", (Date) null);
    ...
    public void toDate() {
        // before 2000
        Date date = Convert.toDate("1998-01-02", (Date) null);
        ...
        // after 2000
        date = Convert.toDate("2008-06-22", (Date) null);
    ...
    public void toDateTime() {
        Date date = Convert.toDateTime("1998-01-02T13:10:00", null);
